...
TABLE = [
    ...
    ("Соколово", None, None, None, "07:45", DAILY),
    ("Островерхівка", "05:50", "06:20", "06:30", "08:00", DAILY),
    ("Соколово", "06:00", "06:30", "06:40", None, DAILY),
    ...
    ("Соколово", "14:10", "14:40", "14:55", "15:55", NO_SUNDAY),
    ...
    # Рядок «Соколово, Островерхівка 17:00/17:30» — одна машина через обидва села. Мереф'янські
    ...
    ("Соколово", "17:00", None, None, "19:10", NO_SUNDAY),
...
ROUTE_INFO = {
    ...
    "Островерхівка": ("ostroverkhivka-kharkiv", None, "Островерхівка"),
    "Рокитне": ("rokytne-kharkiv", None, "Рокитне"),
    "Соколово": ("sokolovo-kharkiv", None, "Соколово"),
    "Утківка": ("utkivka-kharkiv", None, "Утківка"),
